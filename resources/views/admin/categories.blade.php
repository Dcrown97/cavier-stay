                ...
                @forelse ($saleTypes as $saleType)
                    <div class="card m-2" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <p class="card-text"><b>Name:</b> <small>{{ Str::limit($saleType->name, 50) ?? '-' }}
                                </small>
                            </p>
                            <div class="row">
                                <div class="d-flex">
                                    <a class="btn btn-primary mx-2 btn-sm"
                                        href="/admin/edit_categories?id={{ base64_encode($saleType->id) ?? '' }}">
                                        <i class="fa fa-edit"></i> Edit</a>
                                    <a class="btn btn-danger mx-2 btn-sm"
                                        href="/admin/delete_categories?id={{ base64_encode($saleType->id) ?? '' }}">
